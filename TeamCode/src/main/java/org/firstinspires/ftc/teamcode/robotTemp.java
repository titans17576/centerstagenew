 ...
 */
@Config
public class robotTemp extends TankDrive {
    ...
    public DcMotorEx armMotor,leftRear,rightRear;
    ...
    public robotTemp(HardwareMap hardwareMap) {
        ...
        motors = Arrays.asList(leftRear, rightRear, armMotor);
